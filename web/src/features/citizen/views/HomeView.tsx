    ...
    <div className="space-y-8 text-[#0E1726] animate-fade-in font-sans pb-16">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4 pt-2">
          <div className="text-left flex justify-between items-center bg-slate-950/60 backdrop-blur-xl border border-white/10 p-4.5 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.25)]">
