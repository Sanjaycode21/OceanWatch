...
interface HomeViewProps {
  ...
  onNavigateTab: (tab: "home" | "map" | "telemetry" | "report" | "alerts" | "reports" | "sos" | "profile") => void;
  onTriggerSos: () => void;
  locationName?: string;
...
export default function HomeView({
  ...
  // Common card hover transition values (smooth Apple/macOS style spring physics)
    ...
    <div className="space-y-8 text-[#0E1726] animate-fade-in font-sans">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-4 border-b border-[#D5E2EC]">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          <motion.div 
            ...
            whileTap={{ scale: 0.95 }}
            className="p-2 bg-[#F4F8FA] border border-[#D5E2EC] rounded-xl text-[#64748B] cursor-pointer hover:bg-[#EBF2F7] transition-all"
          >
            <Bell size={16} />
          </motion.div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <motion.div 
          ...
          className="p-6 bg-gradient-to-br from-[#0E1726] via-[#1A2536] to-[#0A111F] border border-[#1E293B] rounded-[24px] shadow-lg flex flex-col justify-between h-36 relative overflow-hidden group cursor-default"
        >
        ...
        <motion.div 
          whileHover={cardHoverEffects}
          transition={hoverSpringTransition}
          className="p-5 bg-white border border-[#D5E2EC] rounded-[24px] shadow-sm flex items-center justify-between h-36 cursor-default"
        >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 space-y-8">
          ...
          {/* Nearby Active Incident Warnings */}
          <div className="bg-white border border-[#D5E2EC] p-6 rounded-[24px] shadow-sm space-y-4">
            <div className="flex justify-between items-center pb-2 border-b border-[#D5E2EC]">
              ...
              <button onClick={() => onNavigateTab("alerts")} className="text-[10px] text-[#2563EB] hover:underline font-extrabold flex items-center gap-1 cursor-pointer">
            ...
            <div className="space-y-3.5">
              {nearbyAlerts.map((alt) => (
                <motion.div 
                  key={alt.id} 
                  whileHover={{ x: 4, borderColor: "#2563EB" }}
                  transition={{ duration: 0.15 }}
                  className="p-4 bg-[#F4F8FA]/60 border border-[#D5E2EC] rounded-2xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 transition-all cursor-default"
                >
          ...
          <div className="bg-white border border-[#D5E2EC] p-6 rounded-[24px] shadow-sm space-y-4">
            <div className="flex justify-between items-center pb-3 border-b border-[#D5E2EC]">
              ...
              <button
                ...
                className="text-[10px] text-[#2563EB] hover:underline font-extrabold flex items-center gap-1 cursor-pointer"
              >
            ...
            {reports.length === 0 ? (
              <div className="py-12 text-center text-xs text-[#64748B] bg-[#F4F8FA]/60 border border-dashed border-[#D5E2EC] rounded-xl font-bold uppercase">
        ...
        <div className="xl:col-span-1 space-y-8">
          ...
          {/* Active Swim Recommendation Advice Box */}
          <motion.div 
            whileHover={cardHoverEffects}
            transition={hoverSpringTransition}
            className="bg-amber-50/50 border border-amber-100 p-6 rounded-[24px] shadow-sm space-y-3 text-left cursor-default"
          >
            ...
            <div className="p-3 bg-white border border-amber-200/60 rounded-xl text-[10px] text-[#64748B] font-bold">
          ...
          <div className="space-y-3">
            <span className="text-[9px] text-[#64748B] font-black uppercase tracking-wider block text-left">System Channels</span>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                transition={hoverSpringTransition}
                className="p-4 bg-white border border-[#D5E2EC] hover:border-[#2563EB] rounded-2xl text-left flex flex-col justify-between h-28 hover:shadow-md transition-colors group cursor-pointer"
              >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                transition={hoverSpringTransition}
                className="p-4 bg-red-50/50 border border-red-200 hover:border-red-400 rounded-2xl text-left flex flex-col justify-between h-28 hover:shadow-md transition-colors group cursor-pointer"
              >
          ...
          <motion.div 
            whileHover={cardHoverEffects}
            transition={hoverSpringTransition}
            className="p-6 bg-gradient-to-br from-[#2563EB] to-[#0D9488] border border-blue-500/10 rounded-[28px] text-white flex flex-col justify-between h-48 shadow-lg relative overflow-hidden group cursor-default"
          >
